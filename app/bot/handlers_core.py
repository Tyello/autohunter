...
def _wishlist_help_text() -> str:
    return (
        ...
        "• /wishlist_filter_add <n> mileage_km lte 90000\n"
...
async def cmd_help(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await reply_text(
        ...
        "• /wishlist_track_list <n>\n"
        "• /wishlist_track_remove <n> <slot>\n\n"
        "Campos: price | year | mileage_km | source | color | city | state\n"
        "Ops price/year/mileage_km: lt lte gt gte eq neq\n"
        "Ops source/color/city/state: eq neq\n"
        ...
        "• /wishlist_filter_add 1 mileage_km lte 90000\n"
