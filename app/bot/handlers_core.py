...
async def cmd_help(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await reply_text(
        ...
        "• /wishlist_track_list <n>\n"
        "• /wishlist_track_remove <n> <slot>\n\n"
        "Campos: price | year | mileage_km | source | color | city | state | seller_type (aliases: seller, vendedor, anunciante)\n"
        "Ops price/year/mileage_km: lt lte gt gte eq neq between (alias: entre)\n"
        "Ops source/color/city/state/seller_type: eq neq (aliases: igual/=, apenas/somente, excluir/diferente/!=)\n"
