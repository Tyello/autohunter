...
### 3.2 "Buscar agora" abre instrução de texto, não uma busca — ✅ Concluído no PR #<número>
...
| 3.2 | "Buscar agora" inicia fluxo conversacional | ✅ Concluído PR #<número> | Médio | Médio — UX consistente com o resto do bot |
