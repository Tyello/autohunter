...
### 6.3 Filtros de busca sem exemplos inline — ✅ Concluído no PR #277
...
| 6.3 | Botões de sugestão nos filtros | ✅ Concluído PR #277 | Médio | Médio — elimina erros de formatação |
