...
| Documento | Papel |
|---|---|
| `README.md` | Entrada principal do repo; explica Garagem Alvo vs AutoHunter e aponta leituras. |
...
- `README.md`, `AGENTS.md` e `docs/PROJECT_GUIDELINE.md` já estão alinhados com Garagem Alvo como marca pública e AutoHunter como runtime interno.
- A frente de leilões já possui documentação viva detalhada em `docs/AUCTION_RUNTIME.md`.
- `docs/LEGACY_INVENTORY.md` já reconhece categorias de legado e documentos históricos.
- Faltavam documentos dedicados para arquitetura atual e contexto LLM, adicionados como `docs/ARCHITECTURE.md` e `docs/LLM_CONTEXT.md`.
...
- se tiverem decisões ainda válidas: migrar para `PROJECT_GUIDELINE.md`, `ARCHITECTURE.md`, `AUCTION_RUNTIME.md` ou `OPERATIONS_RUNBOOK.md`;
