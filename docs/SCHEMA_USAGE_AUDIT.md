...
- Migrations Alembic analisadas: **57**
...
|---|---|---:|---|
| `account_id` | `READ_ACTIVE` | hits=74; read=10; write=13; ops=14; idx=4 | ALTO |
| `id` | `READ_ACTIVE` | hits=5529; read=153; write=160; ops=530; idx=28 | ALTO |
...
|---|---|---:|---|
| `id` | `READ_ACTIVE` | hits=5529; read=153; write=160; ops=530; idx=28 | ALTO |
| `is_active` | `READ_ACTIVE` | hits=173; read=33; write=44; ops=19; idx=4 | ALTO |
| `name` | `READ_ACTIVE` | hits=839; read=80; write=103; ops=87; idx=29 | ALTO |
| `type` | `READ_ACTIVE` | hits=955; read=90; write=57; ops=106; idx=8 | ALTO |
...
| `status` | `READ_ACTIVE` | hits=1068; read=97; write=66; ops=247; idx=13 | ALTO |
...
| Coluna | Classificação | Evidência (heurística) | Risco de remoção |
|---|---|---:|---|
| `key` | `READ_ACTIVE` | hits=1306; read=61; write=72; ops=218; idx=29 | ALTO |
| `value` | `READ_ACTIVE` | hits=682; read=68; write=50; ops=12; idx=4 | ALTO |
...
| `source` | `READ_ACTIVE` | hits=2239; read=140; write=119; ops=381; idx=13 | ALTO |
| `status` | `READ_ACTIVE` | hits=1068; read=97; write=66; ops=247; idx=13 | ALTO |
...
| Coluna | Classificação | Evidência (heurística) | Risco de remoção |
|---|---|---:|---|
| `body_type` | `READ_ACTIVE` | hits=78; read=4; write=2; ops=0; idx=1 | ALTO |
| `city` | `READ_ACTIVE` | hits=219; read=32; write=15; ops=0; idx=3 | ALTO |
| `color` | `READ_ACTIVE` | hits=67; read=12; write=9; ops=0; idx=2 | ALTO |
...
| `doors` | `READ_ACTIVE` | hits=106; read=4; write=2; ops=0; idx=1 | ALTO |
...
| `mileage_km` | `READ_ACTIVE` | hits=158; read=22; write=11; ops=0; idx=2 | ALTO |
| `model` | `READ_ACTIVE` | hits=620; read=140; write=32; ops=52; idx=4 | ALTO |
| `price` | `READ_ACTIVE` | hits=1169; read=72; write=55; ops=11; idx=5 | ALTO |
| `raw_payload` | `READ_ACTIVE` | hits=41; read=10; write=2; ops=0; idx=3 | ALTO |
| `seller_type` | `READ_ACTIVE` | hits=105; read=8; write=7; ops=0; idx=1 | ALTO |
| `sold_at` | `READ_ACTIVE` | hits=13; read=1; write=1; ops=0; idx=1 | ALTO |
| `source` | `READ_ACTIVE` | hits=2239; read=140; write=119; ops=381; idx=13 | ALTO |
| `state` | `READ_ACTIVE` | hits=518; read=39; write=21; ops=29; idx=6 | ALTO |
...
| `url` | `READ_ACTIVE` | hits=2435; read=93; write=97; ops=31; idx=6 | ALTO |
| `version` | `READ_ACTIVE` | hits=95; read=21; write=9; ops=0; idx=5 | ALTO |
| `year` | `READ_ACTIVE` | hits=643; read=46; write=25; ops=5; idx=3 | ALTO |
...
|---|---|---:|---|
| `currency` | `READ_ACTIVE` | hits=96; read=18; write=28; ops=1; idx=3 | ALTO |
| `fipe_price` | `READ_ACTIVE` | hits=13; read=4; write=2; ops=0; idx=1 | ALTO |
| `id` | `READ_ACTIVE` | hits=5529; read=153; write=160; ops=530; idx=28 | ALTO |
...
| Coluna | Classificação | Evidência (heurística) | Risco de remoção |
|---|---|---:|---|
| `code` | `READ_ACTIVE` | hits=555; read=51; write=37; ops=57; idx=3 | ALTO |
| `daily_alert_limit` | `READ_ACTIVE` | hits=48; read=11; write=11; ops=7; idx=2 | ALTO |
| `id` | `READ_ACTIVE` | hits=5529; read=153; write=160; ops=530; idx=28 | ALTO |
| `is_active` | `READ_ACTIVE` | hits=173; read=33; write=44; ops=19; idx=4 | ALTO |
| `max_wishlists` | `READ_ACTIVE` | hits=46; read=9; write=9; ops=6; idx=1 | ALTO |
| `name` | `READ_ACTIVE` | hits=839; read=80; write=103; ops=87; idx=29 | ALTO |
...
| `queue` | `READ_ACTIVE` | hits=574; read=25; write=19; ops=80; idx=3 | ALTO |
...
| `extra` | `READ_ACTIVE` | hits=699; read=56; write=45; ops=26; idx=4 | ALTO |
...
| `proxy_server` | `READ_ACTIVE` | hits=133; read=16; write=22; ops=8; idx=2 | ALTO |
| `query` | `READ_ACTIVE` | hits=905; read=107; write=70; ops=75; idx=3 | ALTO |
| `source` | `READ_ACTIVE` | hits=2239; read=140; write=119; ops=381; idx=13 | ALTO |
| `status` | `READ_ACTIVE` | hits=1068; read=97; write=66; ops=247; idx=13 | ALTO |
| `url` | `READ_ACTIVE` | hits=2435; read=93; write=97; ops=31; idx=6 | ALTO |
| `wishlists` | `READ_ACTIVE` | hits=577; read=45; write=24; ops=28; idx=10 | ALTO |
...
| `last_seen_at` | `READ_ACTIVE` | hits=41; read=15; write=9; ops=5; idx=6 | ALTO |
| `runs` | `READ_ACTIVE` | hits=76; read=12; write=6; ops=15; idx=5 | ALTO |
| `source` | `READ_ACTIVE` | hits=2239; read=140; write=119; ops=381; idx=13 | ALTO |
| `url` | `READ_ACTIVE` | hits=2435; read=93; write=97; ops=31; idx=6 | ALTO |

### `subscriptions` (Subscription)
- Model: `app/models/subscription.py`
- Menções em migrations: 26
...
| `plan_id` | `READ_ACTIVE` | hits=24; read=9; write=10; ops=3; idx=1 | ALTO |
| `source` | `READ_ACTIVE` | hits=2239; read=140; write=119; ops=381; idx=13 | ALTO |
| `starts_at` | `READ_ACTIVE` | hits=17; read=6; write=6; ops=6; idx=1 | ALTO |
| `status` | `READ_ACTIVE` | hits=1068; read=97; write=66; ops=247; idx=13 | ALTO |
...
| `message` | `READ_ACTIVE` | hits=649; read=63; write=38; ops=169; idx=6 | ALTO |
| `payload` | `READ_ACTIVE` | hits=496; read=36; write=28; ops=57; idx=7 | ALTO |
...
| `plan` | `READ_ACTIVE` | hits=376; read=28; write=8; ops=55; idx=3 | ALTO |
...
| Coluna | Classificação | Evidência (heurística) | Risco de remoção |
|---|---|---:|---|
| `field` | `READ_ACTIVE` | hits=500; read=39; write=27; ops=14; idx=4 | ALTO |
| `id` | `READ_ACTIVE` | hits=5529; read=153; write=160; ops=530; idx=28 | ALTO |
| `operator` | `READ_ACTIVE` | hits=197; read=21; write=19; ops=1; idx=1 | ALTO |
| `value` | `READ_ACTIVE` | hits=682; read=68; write=50; ops=12; idx=4 | ALTO |
| `wishlist_id` | `READ_ACTIVE` | hits=325; read=29; write=36; ops=3; idx=6 | ALTO |
...
| Coluna | Classificação | Evidência (heurística) | Risco de remoção |
|---|---|---:|---|
| `created_at` | `READ_ACTIVE` | hits=204; read=37; write=19; ops=78; idx=3 | ALTO |
| `token` | `READ_ACTIVE` | hits=454; read=31; write=18; ops=40; idx=3 | ALTO |
| `wishlist_id` | `READ_ACTIVE` | hits=325; read=29; write=36; ops=3; idx=6 | ALTO |
...
## Candidatos priorizados (heurístico)

## Próxima migration sugerida (NÃO aplicada nesta etapa)
1. Validar candidatos `LEGACY_CANDIDATE` em produção (queries reais/pg_stat_statements + logs).
2. Separar remoções por domínio (ops, tracking, listing, billing) em migrations pequenas.
3. Fazer rollout em 2 fases: remover leitura -> remover escrita -> drop coluna/tabela.
4. Criar migration com `DROP COLUMN/TABLE` apenas após janela de observabilidade sem uso.
